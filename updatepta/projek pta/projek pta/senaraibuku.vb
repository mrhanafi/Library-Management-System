...
Public Class senaraibuku
    ...
    Private Sub senaraibuku_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        datagrid()
    End Sub
    Public Sub datagrid()
        ...
        sqlsearch = "SELECT NomborBuku,Tajuk,Kategori,NomborIsbn,Pengarang,Penerbit,TahunTerbit FROM maklumatbuku"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        e.Graphics.DrawString("SENARAI BUKU", dFont, Brush, 330.0F, 100.0F, dFormat)
