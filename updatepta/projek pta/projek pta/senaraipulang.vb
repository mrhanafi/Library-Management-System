...
Public Class senaraipulang
    ...
    End Structure
    Private Sub senaraipulang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        datagrid()
    End Sub
    Public Sub datagrid()
        ...
        sqlsearch = "SELECT IdPeminjam,IdBuku,Kelas,Tajuk,TarikhPinjam,TarikhPulang FROM pemulangan"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        e.Graphics.DrawString("SENARAI PEMULANGAN", dFont, Brush, 330.0F, 100.0F, dFormat)
