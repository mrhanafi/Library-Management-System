...
Public Class senaraiahli
    ...
    End Structure
    Private Sub senaraiahli_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        datagrid()
    End Sub
    Public Sub datagrid()
        ...
        sqlsearch = "SELECT NomborAhli,Nama,Alamat,NomborTelifon,Status,Kategori,Kelas FROM DaftarAhli"
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        e.Graphics.DrawString("SENARAI AHLI", dFont, Brush, 330.0F, 100.0F, dFormat)
